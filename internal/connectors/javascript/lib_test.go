...
func TestNewConnector(t *testing.T) {
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			if connector.DisplayName != "Javascript" {
				t.Errorf("NewConnector() Name = %s, want %s", connector.DisplayName, "Javascript")
			}

			if connector.Description != "javascript connector for running javascript codes" {
				t.Errorf("NewConnector() Description = %s, want %s", connector.Description, "javascript connector for running javascript codes")
			}

			if connector.Logo != "logos:javascript" {
				t.Errorf("NewConnector() Logo = %s, want %s", connector.Logo, "logos:javascript")
			}
