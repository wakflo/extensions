...
func (t *TicketCreated) Run(ctx *sdk.RunContext) (sdk2.JSON, error) {
	reqURL := "/crm/v3/objects/tickets?limit=50&archived=false&properties=createdAt,updatedAt"
...
func (t *TicketCreated) Test(ctx *sdk.RunContext) (sdk2.JSON, error) {
	return t.Run(ctx)
}
