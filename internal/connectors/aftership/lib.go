...
func NewConnector() (*sdk.ConnectorPlugin, error) {
	return sdk.CreateConnector(&sdk.CreateConnectorArgs{
		Name:        "AfterShip",
		Description: "easy-to-use package tracker with which you will know when your parcel will arrive.",
		Logo:        "openmoji:red-hexagon",
		Version:     "0.0.1",
		Group:       sdk.ConnectorGroupApps,
		Authors:     []string{"Wakflo <integrations@wakflo.com>"},
		Triggers:    []sdk.ITrigger{},
		Operations: []sdk.IOperation{
			NewGetCouriersOperation(),
			NewGetATrackingOperation(),
			NewGetAllTrackingsOperation(),
