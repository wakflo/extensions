...
func (c CreatePhotoPostAction) Documentation() *integration.OperationDocumentation {
...
func (c CreatePhotoPostAction) Auth() *integration.Auth {
	return &integration.Auth{
		Inherit: true,
	}
}

func (c CreatePhotoPostAction) Perform(ctx integration.PerformContext) (sdkcore.JSON, error) {
	input, err := integration.InputToTypeSafely[createPhotoPostActionProps](ctx.BaseContext)
	if err != nil {
		return nil, err
	}
...
func NewCreatePhotoPostAction() integration.Action {
