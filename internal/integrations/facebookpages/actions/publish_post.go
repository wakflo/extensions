...
func (c PublishPostAction) Documentation() *sdk.OperationDocumentation {
...
func (c PublishPostAction) Auth() *sdk.Auth {
	return &sdk.Auth{
		Inherit: true,
	}
}

func (c PublishPostAction) Perform(ctx sdk.PerformContext) (sdkcore.JSON, error) {
	input, err := sdk.InputToTypeSafely[publishPostActionProps](ctx.BaseContext)
	if err != nil {
		return nil, err
	}
