...
func (c CreateVideoPostAction) Documentation() *integration.OperationDocumentation {
...
func (c CreateVideoPostAction) Auth() *integration.Auth {
	return &integration.Auth{
		Inherit: true,
	}
}

func (c CreateVideoPostAction) Perform(ctx integration.PerformContext) (sdkcore.JSON, error) {
	input, err := integration.InputToTypeSafely[createVideoPostActionProps](ctx.BaseContext)
	if err != nil {
		return nil, err
	}
...
func NewCreateVideoPostAction() integration.Action {
