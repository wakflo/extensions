...
func GetInstagramPageInput(title string, desc string, required bool) *sdkcore.AutoFormSchema {
...
func GetPageAccessToken(userAccessToken, pageID string) (string, error) {
	...
	result, err := MakeInstagramRequest(http.MethodGet, userAccessToken, endpoint, nil)
	if err != nil {
...
func ActionFunc(pageAccessToken, endpoint string, payload map[string]interface{}) ([]map[string]interface{}, error) {
	result, err := MakeInstagramRequest(http.MethodGet, pageAccessToken, endpoint, payload)
	if err != nil {
...
func PostActionFunc(pageAccessToken, method, endpoint string, payload map[string]interface{}) (map[string]interface{}, error) {
	result, err := MakeInstagramRequest(method, pageAccessToken, endpoint, payload)
	if err != nil {
