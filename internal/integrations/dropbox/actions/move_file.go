...
type moveFileActionProps struct {
...
func (a *MoveFileAction) Metadata() sdk.ActionMetadata {
	return sdk.ActionMetadata{
		ID:            "move_file",
		DisplayName:   "Move a File",
		Description:   "move file",
		Type:          core.ActionTypeAction,
		Documentation: moveFileDocs,
...
func (a *MoveFileAction) Properties() *smartform.FormSchema {
	form := smartform.NewForm("move_file", "Move a File")

	form.TextField("from_path", "From Path").
		Required(true).
		HelpText("The current path of the file (e.g. /folder1/oldfile.txt)")

	form.TextField("to_path", "To Path").
		Required(true).
		HelpText("The new path for the file (e.g. /folder2/newfile.txt)")
...
func (a *MoveFileAction) Auth() *core.AuthMetadata {
	return nil
}

// Perform executes the action with the given context and input
func (a *MoveFileAction) Perform(ctx sdkcontext.PerformContext) (core.JSON, error) {
...
func NewMoveFileAction() sdk.Action {
